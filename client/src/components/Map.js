            ...
            <svg className="map-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1035.23 722.8">
                <g id="Слой_2" data-name="Слой 2">
                    <g id="Слой_1-2" data-name="Слой 1">
                        <path id="US-AK" className="block-3 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-AK").id)}
                        ...
                        <path id="US-AL" className="block-14 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-AL").id)}
                        ...
                        <path id="US-AR" className="block-13 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-AR").id)}
                        ...
                        <path id="US-AZ" className="block-4 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-AZ").id)}
                        ...
                        <path id="US-CA" className="block-2 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-CA").id)}
                        ...
                        <path id="US-CO" className="block-6 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-CO").id)}
                        ...
                        <path id="US-CT" className="block-25 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-CT").id)}
                              d="M978.26,166.27l3.4,11.94-.13,3.48-7,3.07-9.34,3.62-11.66,8.5-1.27-2.54,3.08-3.06-1.78-1.54-3.33-17.07,12.66-2.83Z"/>
                        <path id="US-DE" className="block-21 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-DE").id)}
                              d="M930.35,230.21l-2,2.89,1.42,4.5,6.32,11.08,7.33,10.2-11.58,2.66-7.64-27.9.91-2,1.31-1.34Z"/>
                        <path id="US-FL" className="block-17 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-FL").id)}
                        ...
                        <path id="US-GA" className="block-17 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-GA").id)}
                        ...
                        <path id="US-HI" className="block-3 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-HI").id)}
                        ...
                        <path id="US-IA" className="block-10 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-IA").id)}
                        ...
                        <path id="US-ID" className="block-5 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-ID").id)}
                        ...
                        <path id="US-IL" className="block-12 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-IL").id)}
                        ...
                        <path id="US-IN" className="block-16 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-IN").id)}
                        ...
                        <path id="US-KS" className="block-8 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-KS").id)}
                        ...
                        <path id="US-KY" className="block-15 cls-1  grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-KY").id)}
                        ...
                        <path id="US-LA" className="block-13 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-LA").id)}
                        ...
                        <path id="US-MA" className="block-24 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-MA").id)}
                        ...
                        <path id="US-MD" className="block-20 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-MD").id)}
                        ...
                        <path id="US-ME" className="block-23 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-ME").id)}
                        ...
                        <path id="US-MI" className="block-16 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-MI").id)}
                        ...
                        <path id="US-MN" className="block-11 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-MN").id)}
                        ...
                        <path id="US-MO" className="block-12 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-MO").id)}
                        ...
                        <path id="US-MS" className="block-14 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-MS").id)}
                        ...
                        <path id="US-MT" className="block-5 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-MT").id)}
                        ...
                        <path id="US-NC" className="block-18 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-NC").id)}
                        ...
                        <path id="US-ND" className="block-9 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-ND").id)}
                        ...
                        <path id="US-NE" className="block-10 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-NE").id)}
                        ...
                        <path id="US-NH" className="block-23 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-NH").id)}
                        ...
                        <path id="US-NJ" className="block-21 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-NJ").id)}
                        ...
                        <path id="US-NM" className="block-7 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-NM").id)}
                        ...
                        <path id="US-NV" className="block-2 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-NV").id)}
                        ...
                        <path id="US-NY" className="block-22 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-NY").id)}
                        ...
                        <path id="US-OH" className="block-19 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-OH").id)}
                        ...
                        <path id="US-OK" className="block-8 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-OK").id)}
                        ...
                        <path id="US-OR" className="block-1 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-OR").id)}
                        ...
                        <path id="US-PA" className="block-22 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-PA").id)}
                        ...
                        <path id="US-RI" className="block-25 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-RI").id)}
                              d="M992.56,174.53l-11,7.16.13-3.48-3.4-11.94,6.82-2.14,2.81,5.4,3.28,1.79Z"/>
                        <path id="US-SC" className="block-18 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-SC").id)}
                        ...
                        <path id="US-SD" className="block-9  cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-SD").id)}
                        ...
                        <path id="US-TN" className="block-15 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-TN").id)}
                        ...
                        <path id="US-TX" className="block-7 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-TX").id)}
                        ...
                        <path id="US-UT" className="block-4 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-UT").id)}
                              d="M349.47,227.4l-12.84,89.85-26.07-4.15-34.44-6L247.24,302l22.29-111.18,49.76,9-3.72,21.79Z"/>
                        <path id="US-VA" className="block-20 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-VA").id)}
                        ...
                        <path id="US-VT" className="block-24 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-VT").id)}
                        ...
                        <path id="US-WA" className="block-1 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-WA").id)}
                        ...
                        <path id="US-WI" className="block-11 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-WI").id)}
                        ...
                        <path id="US-WV" className="block-19 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-WV").id)}
                        ...
                        <path id="US-WY" className="block-6 cls-1 grey"
                              onMouseOver={(event) => props.taskReturn(event.currentTarget.classList[0])}
                              onClick={() => props.colorChange(document.getElementById("US-WY").id)}
