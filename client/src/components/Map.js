        ...
        return (
            <div className="map-background">
                <svg className="map-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1035.23 722.8">
                    <path id="US-AK" className={"block-3 cls-1 " + this.props.votes.find((item)=>{ return item.block === "block-3"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-3")}
                    ...
                    <path id="US-AL" className={"block-14 cls-1 " + this.props.votes.find((item)=>{ return item.block === "block-14"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-14")}
                    ...
                    <path id="US-AR" className={"block-13 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-13"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-13")}
                    ...
                    <path id="US-AZ" className={"block-4 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-4"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-4")}
                    ...
                    <path id="US-CA" className={"block-2 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-2"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-2")}
                    ...
                    <path id="US-CO" className={"block-6 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-6"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-6")}
                    ...
                    <path id="US-CT" className={"block-25 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-25"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-25")}
                          d="M978.26,166.27l3.4,11.94-.13,3.48-7,3.07-9.34,3.62-11.66,8.5-1.27-2.54,3.08-3.06-1.78-1.54-3.33-17.07,12.66-2.83Z"/>
                    <path id="US-DE" className={"block-21 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-21"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-21")}
                          d="M930.35,230.21l-2,2.89,1.42,4.5,6.32,11.08,7.33,10.2-11.58,2.66-7.64-27.9.91-2,1.31-1.34Z"/>
                    <path id="US-FL" className={"block-17 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-17"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-17")}
                    ...
                    <path id="US-GA" className={"block-17 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-17"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-17")}
                    ...
                    <path id="US-HI" className={"block-3 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-3"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-3")}
                    ...
                    <path id="US-IA" className={"block-10 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-10"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-10")}
                    ...
                    <path id="US-ID" className={"block-5 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-5"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-5")}
                    ...
                    <path id="US-IL" className={"block-12 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-12"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-12")}
                    ...
                    <path id="US-IN" className={"block-16 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-16"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-16")}
                    ...
                    <path id="US-KS" className={"block-8 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-8"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-8")}
                    ...
                    <path id="US-KY" className={"block-15 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-15"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-15")}
                    ...
                    <path id="US-LA" className={"block-13 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-13"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-13")}
                    ...
                    <path id="US-MA" className={"block-24 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-24"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-24")}
                    ...
                    <path id="US-MD" className={"block-20 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-20"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-20")}
                    ...
                    <path id="US-ME" className={"block-23 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-23"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-23")}
                    ...
                    <path id="US-MI" className={"block-16 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-16"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-16")}
                    ...
                    <path id="US-MN" className={"block-11 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-11"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-11")}
                    ...
                    <path id="US-MO" className={"block-12 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-12"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-12")}
                    ...
                    <path id="US-MS" className={"block-14 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-14"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-14")}
                    ...
                    <path id="US-MT" className={"block-5 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-5"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-5")}
                    ...
                    <path id="US-NC" className={"block-18 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-18"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-18")}
                    ...
                    <path id="US-ND" className={"block-9 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-9"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-9")}
                    ...
                    <path id="US-NE" className={"block-10 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-10"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-10")}
                    ...
                    <path id="US-NH" className={"block-23 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-23"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-23")}
                    ...
                    <path id="US-NJ" className={"block-21 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-21"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-21")}
                    ...
                    <path id="US-NM" className={"block-7 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-7"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-7")}
                    ...
                    <path id="US-NV" className={"block-2 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-2"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-2")}
                    ...
                    <path id="US-NY" className={"block-22 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-22"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-22")}
                    ...
                    <path id="US-OH" className={"block-19 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-19"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-19")}
                    ...
                    <path id="US-OK" className={"block-8 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-8"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-8")}
                    ...
                    <path id="US-OR" className={"block-1 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-1"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-1")}
                    ...
                    <path id="US-PA" className={"block-22 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-22"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-22")}
                    ...
                    <path id="US-RI" className={"block-25 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-25"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-25")}
                          d="M992.56,174.53l-11,7.16.13-3.48-3.4-11.94,6.82-2.14,2.81,5.4,3.28,1.79Z"/>
                    <path id="US-SC" className={"block-18 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-18"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-18")}
                    ...
                    <path id="US-SD" className={"block-9  cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-9"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-9")}
                    ...
                    <path id="US-TN" className={"block-15 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-15"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-15")}
                    ...
                    <path id="US-TX" className={"block-7 cls-1 "+ this.props.votes.find((item)=>{ return item.block === "block-7"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-7")}
                    ...
                    <path id="US-UT" className={"block-4 cls-1 " + this.props.votes.find((item)=>{ return item.block === "block-4"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-4")}
                          d="M349.47,227.4l-12.84,89.85-26.07-4.15-34.44-6L247.24,302l22.29-111.18,49.76,9-3.72,21.79Z"/>
                    <path id="US-VA" className={"block-20 cls-1 " + this.props.votes.find((item)=>{ return item.block === "block-20"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-20")}
                    ...
                    <path id="US-VT" className={"block-24 cls-1 " + this.props.votes.find((item)=>{ return item.block === "block-24"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-24")}
                    ...
                    <path id="US-WA" className={"block-1 cls-1 " + this.props.votes.find((item)=>{ return item.block === "block-1"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-1")}
                    ...
                    <path id="US-WI" className={"block-11 cls-1 " + this.props.votes.find((item)=>{ return item.block === "block-11"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-11")}
                    ...
                    <path id="US-WV" className={"block-19 cls-1 " + this.props.votes.find((item)=>{ return item.block === "block-19"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-19")}
                    ...
                    <path id="US-WY" className={"block-6 cls-1 " + this.props.votes.find((item)=>{ return item.block === "block-6"}).voteOwner}
                          onMouseOver={(event) => this.props.taskReturn(event.currentTarget.classList[0])}
                          onClick={() => this.props.colorChange("block-6")}
